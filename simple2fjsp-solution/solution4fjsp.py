...
class JobEnv:
    def __init__(self, case_name, path, only_PDR=False):
        ...
        self.busy_job = None
        self.max_order_num = max(self.orders_of_job.values())
        # state features are solution table
        self.state_num = self.job_num * self.max_order_num
        self.state = None
        self.job_dict = None
    ...
    def allocate_job(self, job_id, sign):
        ...
        self.state[job_id][self.current_op_of_job[job_id]] = self.solution_op_cnt / self.scale
